...
namespace Net.Xmpp.Im
{
    ...
    public class JidPrivacyRule : PrivacyRule
    {
        ...
        /// <param name="allow">True to allow entities affected by this rule; Otherwise false.</param>
        /// <param name="order">The order of the privacy rule.</param>
        /// <param name="granularity">Specifies which kinds of stanzas should be allowed or blocked, respectively.</param>
